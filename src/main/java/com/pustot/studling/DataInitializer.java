...
//
//    public DataInitializer(UserMapper userMapper, WordRepository wordRepository
...
//        user1.setCognitoSub("cognitoSub1");
//        user1.setCreatedAt(LocalDateTime.now());
//        user1.setUpdatedAt(LocalDateTime.now());
//
//        User user2 = new User();
//        user2.setEmail("default2@example.com");
//        user2.setCognitoSub("c714ca08-7021-70f4-318d-ff9a51d36a89");
